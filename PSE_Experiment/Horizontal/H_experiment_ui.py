...
class ExperimentUI:
    def __init__(self, controller=None, left_trials=None, right_trials=None,
        ...
        # ----- Rest page -----
        self.rest_label = tk.Label(self.rest_frame, text="right trials completed.\n\nPlease rest.\n\nPress SPACE to begin the left trials.",
...
if __name__ == '__main__':
    ...
    left_trials = get_trial_moves(pair_count, direction="right")
    right_trials = get_trial_moves(pair_count, direction="left")
